...
lint = ruff subtractor test
pytest = pytest --asyncio-mode=strict --cov=subtractor --cov-report term-missing:skip-covered --cov-branch --log-format="%(levelname)s %(message)s"
types = mypy subtractor
